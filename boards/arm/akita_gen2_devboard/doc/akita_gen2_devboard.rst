.. _akita_gen2_devboard:

blik AKITA Gen2 devboard
##############

Overview
********

The AKITA Gen2 devboard is a FRDM-KW41Z board with custom configuration. 
...
The akita_gen2_devboard board configuration supports the following hardware features:
...
The default configuration can be found in the defconfig file:
	...
	``boards/arm/akita_gen2_devboard/akita_gen2_devboard_defconfig``
...
With these mechanisms, applications for the ``akita_gen2_devboard`` board
