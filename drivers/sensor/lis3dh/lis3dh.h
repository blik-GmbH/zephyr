...
#define LIS3DH_ST0_SHIFT		1
#define LIS3DH_ST0		BIT(LIS3DH_ST0_SHIFT)
#define LIS3DH_ST1_SHIFT		2
#define LIS3DH_ST1		BIT(LIS3DH_ST1_SHIFT)

#if defined(CONFIG_LIS3DH_SELF_TEST_DIS)
	#define LIS3DH_ST_BITS		0
#elif defined(CONFIG_LIS3DH_SELF_TEST_POS)
	#define LIS3DH_ST_BITS		LIS3DH_ST0
#elif defined(CONFIG_LIS3DH_SELF_TEST_NEG)
	#define LIS3DH_ST_BITS		LIS3DH_ST1
#endif
